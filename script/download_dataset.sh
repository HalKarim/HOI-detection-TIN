...
#cd ../
python script_pick_annotations.py /DATACENTER1/zhw/data/v-coco/coco/annotations
...
cd /DATACENTER1/zhw/data/
git clone https://github.com/ywchao/ho-rcnn.git
#cd ../
cp home/zhw/Transferable-Interactiveness-Network/script/Generate_detection.m DATACENTER1/zhw/data/ho-rcnn/
cp home/zhw/Transferable-Interactiveness-Network/script/save_mat.m DATACENTER1/zhw/data/ho-rcnn/
cp home/zhw/Transferable-Interactiveness-Network/script/load_mat.m DATACENTER1/zhw/data/ho-rcnn/

mkdir DATACENTER1/zhw/data/ho-rcnn/data/hico_20160224_det/
cp DATACENTER1/zhw/data/hico_20160224_det/anno_bbox.mat DATACENTER1/zhw/data/ho-rcnn/data/hico_20160224_det/
cp DATACENTER1/zhw/data/hico_20160224_det/anno.mat DATACENTER1/zhw/data/ho-rcnn/data/hico_20160224_det/
