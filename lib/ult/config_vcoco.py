...
__C.TRAIN = edict()
#######################################################################################################################
# Training setting: 1--H+O+SP+D, 2--H+O+SP, 3--D, 4--H+O, 5--SP
__C.TRAIN_MODULE = 1 # do not change this for reason of NONE grads

# Training setting: 1--Update_all_parameter, 2--Only_Update_D, 3--Update_H+O+SP, 4--update except classifiers of S(fc)
...
# Global step: 1--from previous global step  2--from 0
__C.TRAIN_GLOBAL_STEP_CONTINUE = 2

# Initial learning rate
__C.TRAIN.LEARNING_RATE = 0.000002 #0.001-default, now 0.0001 is suitable for D
...
#__C.DATA_DIR = osp.abspath(osp.join('/DATACENTER1/zhw/data'))
