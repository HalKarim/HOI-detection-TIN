...
from lib.ult.ult import Get_Next_Instance_HO_Neg_HICO_pose_pattern_version2
from lib.ult.timer import Timer
        ...
        while iter < max_iters + 1:
            ...
            if iter % (cfg.TRAIN.DISPLAY) == 0:
                print('iter: %d / %d, im_id: %u, total loss: %.6f, lr: %f, speed: %.3f s/iter' % \
                      (iter, max_iters, self.Trainval_GT[iter%Data_length][0][0], total_loss, lr.eval(), timer.average_time))
